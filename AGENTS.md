# HomeWellness Companion — AGENTS.md
...
**一句話**：`st.fragment(run_every=5s)` 每 5 秒輪詢 IoT 數據，異常時自動觸發 CareAgent；長者也可以直接對話。
...
| 主題 | 文件 |
|------|------|
| 專案結構 & 啟動 | `.Codex/reference/project-overview.md` |
| 三代理架構設計 | `.Codex/reference/multi-agent.md` |
| 5 個 LangChain 工具 | `.Codex/reference/tools.md` |
| Session 記憶實作 | `.Codex/reference/memory.md` |
| 三個 System Prompt | `.Codex/reference/prompts.md` |
| IoT Mock 資料層 | `.Codex/reference/iot-layer.md` |
| Streamlit UI + Scheduler | `.Codex/reference/ui-scheduler.md` |
...
禁止：`Co-Authored-By: Codex` 或任何 AI 署名  
